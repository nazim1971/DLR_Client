...
import UpdateArtistModal from "../../../Modal/UpdateArtistModal";

const AllArtists = ({artist,refetch}) => {
        ...
        try {
            Swal.fire({
              ...
              if (result.isConfirmed) {
                 await axiosPublic.delete(`/v1/artist/deleteArtist/${id}`);
    ...
    return (
        ...
        <UpdateArtistModal id={id} refetch={refetch}  />
        </div>
    );
};
